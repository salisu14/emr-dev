            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="relative overflow-x-auto  sm:rounded-lg">
                        ...
                        <table class="min-w-full leading-normal">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-5 py-3 text-base bg-white border-b border-gray-200 capitalize">
                                        {{ $patient->gender }}
                                    </td>
                                    ...
                                    <td class="px-5 py-3 text-base bg-white border-b border-gray-200">
                                        ...
                                        <form class="inline" action="{{ route('patients.destroy', $patient) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <div class="flex justify-center items-center text-sm mt-4">{{ $patients->links() }}</div>
                        
                        <div class="flex items-center justify-end mt-2">
                            <x-primary-link href="{{ route('patients.create') }}">
                                {{ __('Add New') }}
                            </x-primary-link>
                        </div>
