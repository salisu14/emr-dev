                    ...
                    <div class="relative overflow-x-auto  sm:rounded-lg">
                        ...
                        <x-card>
                            <div class="mb-4">
                                ...
                                <p class="text-gray-900">{{ $medication->name }}</p>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-gray-900">{{ $medication->dosage }}</p>
                            </div>
                            <div class="mb-4">
                                <strong class="text-gray-700">Frequency:</strong>
                                <p class="text-gray-900">{{ $medication->frequency }}</p>
                            </div>
                            <div class="mb-4">
                                <strong class="text-gray-700">Instructions:</strong>
                                <p class="text-gray-900">{{ $medication->instructions }}</p>
                            </div>
                            <div class="mb-4">
                                <strong class="text-gray-700">Date Created:</strong>
                                <p class="text-gray-900">{{ $medication->created_at->toFormattedDateString() }}</p>
                            </div>
